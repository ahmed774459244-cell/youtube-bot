...
TEXTS = {
    "uz": {
        ...
        "queue_msg": "⏳ Navbatdasiz — sizdan oldin {position} ta video ishlanmoqda/kutmoqda. Taxminiy kutish vaqti: {wait_time}. Navbat kelganda avtomatik boshlanadi.",
        ...
        "ask_channel_niche": "🏷 Kanalingiz qanday mavzuda? (masalan: futbol, oshxona, sayohat, texnologiya)",
        "branding_ready": "✅ Kanal brendi tayyor!",
    ...
    "en": {
        ...
        "queue_msg": "⏳ You're in the queue — {position} video(s) ahead of you. Estimated wait: {wait_time}. It will start automatically.",
        ...
        "ask_channel_niche": "🏷 What is your channel's niche/topic? (e.g. football, cooking, travel, tech)",
        "branding_ready": "✅ Channel branding is ready!",
    ...
    "ru": {
        ...
        "queue_msg": "⏳ Вы в очереди — перед вами {position} видео. Примерное время ожидания: {wait_time}. Начнётся автоматически.",
        ...
        "ask_channel_niche": "🏷 Какая тематика вашего канала? (например: футбол, кулинария, путешествия, технологии)",
        "branding_ready": "✅ Брендинг канала готов!",
